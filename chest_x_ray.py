...
# normal X-ray
learn_inf.predict('/content/drive/MyDrive/fastai/val/NORMAL/NORMAL2-IM-1427-0001.jpeg')

learn_inf.predict('/content/drive/MyDrive/fastai/val/PNEUMONIA/person1946_bacteria_4874.jpeg')

learn_inf.predict('/content/drive/MyDrive/fastai/val/NORMAL/NORMAL2-IM-1431-0001.jpeg')

learn_inf.predict('/content/drive/MyDrive/fastai/val/NORMAL/NORMAL2-IM-1440-0001.jpeg')
